...
public static class AssertionConcern
{
    ...
    public static void ValidateLength(string valor, int maximo, string mensagem)
    {
    ...
    public static void ValidateLength(string valor, int minimo, int maximo, string mensagem)
    {
        var length = valor.Trim().Length;
    ...
    public static void ValidateIfLessOrEqual(long valor, long minimo, string mensagem)
    {
        if (valor < minimo)
        {
            throw new DomainException(mensagem);
    ...
    public static void ValidateIfLess(double valor, double minimo, string mensagem)
    {
        if (valor < minimo)
        {
            throw new DomainException(mensagem);
    ...
    public static void ValidateIfLess(decimal valor, decimal minimo, string mensagem)
    {
        if (valor < minimo)
        {
            throw new DomainException(mensagem);
    ...
    public static void ValidateIfLess(int valor, int minimo, string mensagem)
    {
        if (valor < minimo)
        {
            throw new DomainException(mensagem);
